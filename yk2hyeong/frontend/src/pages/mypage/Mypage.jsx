    ...
    <div>
      <main>
        ...
        {menuTab === 'notification' ? (
          <RadioGroup readStatus={readStatus} setReadStatus={setReadStatus} />
        ) : (
          <SelectGroup
        ...
        <div className="content">
          {menuTab === 'regist' && (
            <RegisteredProduct selectedYear={selectedYear} selectedMonth={selectedMonth} />
          )}
          {menuTab === 'purchase' && (
            <PurchaseProduct selectedYear={selectedYear} selectedMonth={selectedMonth} />
          )}
          {menuTab === 'wishlist' && (
            <WishlistProduct selectedYear={selectedYear} selectedMonth={selectedMonth} />
          )}
