...
function SellerTerms() {
    ...
    const handleNext = () => {
        ...
        navigate('/signup/seller/form'); // 약관에 동의하면 다음 단계로 이동
    };
    ...
    return (
        <div className="terms-container">
            ...
            <div className="terms-box">
                ...
                {expanded.terms && <div className="terms-content"><p>[서비스 이용약관 내용입니다...]</p></div>}
            </div>
            ...
            <div className="terms-box">
                ...
                {expanded.privacy && <div className="terms-content"><p>[개인정보 수집 및 동의 내용입니다...]</p></div>}
            </div>
            ...
            <div className="terms-box">
                ...
                {expanded.thirdparty && <div className="terms-content"><p>[제3자 정보제공 동의 내용입니다...]</p></div>}
            </div>
