                ...
                {activeTab === 'breadcrumb' && (
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center' }}>
                            ...
                            />
                            <pre style={{ marginLeft: 20, backgroundColor: '#f4f4f4', padding: '10px', borderRadius: '5px', fontSize: '14px' }}>
                                {`<CustomInputNumber defaultValue={100} min={0} max={200} step={1} onChange={(val) => console.log('값 변경:', val)} className="my-custom-class"/>`}
                            </pre>
                        </div>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center' }}>
                            ...
                            />
                            <pre style={{ marginLeft: 20, backgroundColor: '#f4f4f4', padding: '10px', borderRadius: '5px', fontSize: '14px' }}>
                                {`<CustomUpload action="https://660d2bd96ddfa2943b33731c.mockapi.io/api/upload" onChange={handleFileChange} defaultFileList={defaultFiles} buttonText="Upload Files"/>`}
                            </pre>
                        </div>
                ...
                {activeTab === 'cards' && (
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center' }}>
                            ...
                            />
                            <pre style={{ marginLeft: 20, backgroundColor: '#f4f4f4', padding: '10px', borderRadius: '5px', fontSize: '14px' }}>
                                {`<CustomCard title="Europe Street beat" description="www.instagram.com" image="https://os.alipayobjects.com/rmsportal/QBnOOoLaAfKPirc.png" layout="column"/>`}
                            </pre>
                        </div>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center' }}>
                            ...
                            />
                            <pre style={{ marginLeft: 20, backgroundColor: '#f4f4f4', padding: '10px', borderRadius: '5px', fontSize: '14px' }}>
                                {`<CustomCard title="Europe Street beat" description="www.instagram.com" image="https://os.alipayobjects.com/rmsportal/QBnOOoLaAfKPirc.png" layout="row"/>`}
                            </pre>
                        </div>
                    </div>
                )}
