...
function ProductForm({product}){
    ...
    return(
        <form className="product-form-content">
            ...
            <label>
                <span>예약 시작일:</span>
                <input type="date" value={form.productRevStart ? form.productRevStart.slice(0, 10) : ''} readOnly />
            </label>
            <label>
                <span>예약 종료일:</span>
                <input type="date" value={form.productRevEnd ? form.productRevEnd.slice(0, 10) : ''} readOnly />
            </label>
            <label>
                <span>판매자 ID:</span>
